    ...
    public partial class FrmTask : Form
    {
        ...
        private void FrmTask_Load(object sender, EventArgs e)
        {
            ...
            if(IsUpdate)
            {
                ...
                cmbTaskState.DataSource = dto.TaskStates;
                cmbTaskState.DisplayMember = "TaskState";
                cmbTaskState.ValueMember = "ID";
                cmbTaskState.SelectedIndex = detail.TaskStateID-1;
                Console.WriteLine(detail.Name);
                Console.WriteLine(detail.UserNo);
                Console.WriteLine(detail.TaskID);
                Console.WriteLine(detail.TaskStateID);
                Console.WriteLine(detail.StateName);
            }
